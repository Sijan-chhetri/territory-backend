...
/**
 * Android checks this exact URL:
 * https://territory-backend-3.onrender.com/.well-known/assetlinks.json
 *
 * Set:
 * ANDROID_SHA256_CERT_FINGERPRINTS=AA:BB:...,11:22:...
 */
router.get("/.well-known/assetlinks.json", (_req, res) => {
  ...
  // Do not deploy production with an empty fingerprint list.
  res
    .status(200)
                ...
                components: [
                  {
                    "/": "/open/clan-event",
                    comment:
                      "Open DURO directly on Social > Clubs",
                  },
                ],
              },
            ]
 ...
 * Browser fallback.
 *
 * With verified App Links / Universal Links, the OS opens DURO before this
 * route loads. If verification is unavailable or an email client opens an
 * embedded browser, this page attempts the custom scheme and shows store links.
 */
    ...
    return res.status(400).type("html").send(`
      ...
      <html lang="en">
        ...
        <body>
          ...
          <p>The club ID is missing from this invitation.</p>
        </body>
      </html>
    `);
  }
    ...
    <html lang="en">
      ...
      <body>
        <main class="card">
          ...
          <p>
            DURO will open directly on the Social Clubs tab.
          </p>

          <a class="button" href="${safeAppUrl}">
            Open DURO
          </a>
